...
import { Sparkles, Award, TrendingUp, Heart, Users, Trophy, Search, Filter, Star, Calendar, ArrowLeft } from 'lucide-react'
...
const mockStories: SuccessStory[] = [
  {
    id: '1',
    title: 'From Bronze to Platinum',
    titleAr: 'من البرونزي إلى البلاتيني',
    content: 'My journey with Sharjah Youth has been incredible. Starting as a bronze member, I worked hard...',
    contentAr: 'رحلتي مع ناشئة الشارقة كانت رائعة. بدأت كعضو برونزي وعملت بجد للحصول على شارات متعددة واكتشفت شغفي القيادة وخدمة المجتمع.',
    image: '',
    isFeatured: true,
    category: 'Leadership',
    categoryAr: 'القيادة',
  ...
  },
  {
    ...
    contentAr: 'من خلال نظام الشارات، اكتشفت شغفي بالقيادة وخدمة المجتمع، وقادت فرق شابة متعددة في مشاريع ناجحة.',
    image: '',
    isFeatured: true,
    category: 'Community',
    categoryAr: 'المجتمع',
  ...
  },
  {
    ...
    contentAr: 'تطوعت أكثر من 200 ساعة في مساعدة كبار السن وتنظيم فعاليات مجتمعية.',
    image: '',
    isFeatured: false,
    category: 'Community',
    categoryAr: 'المجتمع',
...
const categories = [...new Set(mockStories.map(s => s.category))]
...
export default function SuccessStories() {
  ...
  const filteredStories = mockStories.filter(story => {
    ...
    const matchesLevel = filterLevel === 'all' || story.member.level === filterLevel
                ...
                <SelectContent>
                  {levels.map(level => (
                    <SelectItem key={level} value={level}>
                      {level === 'all' ? 'كل المستويات' : levelLabels[level]}
                    </SelectItem>
                  ))}
                </SelectContent>
              </Select>
                    ...
                    <div className="flex items-center justify-between pt-4 border-t border-gray-200 dark:border-gray-700">
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex flex-col">
                          ...
                          <p className="text-xs text-gray-500">{story.categoryAr}</p>
                        </div>
                      </div>
