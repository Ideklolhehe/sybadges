  ...
  const storiesData = [
    {
      ...
      content: 'My journey with Sharjah Youth has been incredible. Starting as a bronze member, I worked hard to earn multiple badges and discovered my passion for leadership and community service.',
    ...
    },
    {
      ...
      content: 'Through the badge system, I discovered my passion for leadership and community service, and led multiple youth teams in successful projects.',
    ...
    },
    {
      ...
      content: 'The technical badges inspired me to create innovative solutions for real environmental problems in my community.',
    ...
    {
      memberId: memberRecords['MEM004']?.id,
      title: 'Community Hero',
      titleAr: 'بطل المجتمع',
      content: 'Volunteered over 200 hours helping elderly and organizing community events across the emirate.',
    ...
    {
      memberId: memberRecords['MEM005']?.id,
      title: 'Tech Pioneer',
      titleAr: 'رائد التقنية',
      content: 'Created an app to help members track their achievements and share success stories with the community.',
    ...
    if (!existing) {
      await db.successStory.create({
        data: {
          ...
          centerId: story.centerId,
          centerAr: story.centerAr,
          trackId: story.trackId,
          trackAr: story.trackAr,
